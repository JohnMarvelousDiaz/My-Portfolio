...
const socials = [
  { icon: "skill-icons:gmail-light", class: "rounded-lg", link: "mailto:johnmarvelous705@gmail.com" },
  { icon: "skill-icons:linkedin", class: "rounded-lg", link: "https://www.linkedin.com/in/johnmarvelousdiaz/" },
